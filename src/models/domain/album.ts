...
import { UploadedTrackSimpleWithoutAlbumWithPositionInAlbumSchema } from "./uploaded-track";
export const AlbumDetailedSchema = z.object({
  uuid: z.string().uuid(),
  name: z.string(),
  year: z.number().optional(),
  album_artists: z.array(ArtistMinimumSchema),
  library_tracks_sorted: z.array(UploadedTrackSimpleWithoutAlbumWithPositionInAlbumSchema),
